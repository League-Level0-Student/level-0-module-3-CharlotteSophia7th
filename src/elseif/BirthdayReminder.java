...
public class BirthdayReminder {
	...
	public static void main(String[] args) {
		...
		String momsBirthday = "October 23";
		String dadsBirthday = "August 17";
		String myBirthday = "January 21";

		// 2. Find out which birthday the user wants and and store their response in a
		// variable
		String answer = JOptionPane.showInputDialog("Pick either mom, dad, or me.");
